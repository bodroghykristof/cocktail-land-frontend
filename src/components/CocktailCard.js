  ...
  const addFavorites = (e) => {
    ...
    if (!bools.includes(true)) {
      setFavorites((prevFavorites) => [
        ...prevFavorites,
        { strDrink: strDrink, idDrink: idDrink, strDrinkThumb: strDrinkThumb },
      ]);
    }
  };
      ...
      <Card className='card'>
        ...
        <span>
          ...
          <Button
            ...
            name={strDrink}
            value={favoriteNames.includes(strDrink) ? 'false' : 'true'}
          >
            {favoriteNames.includes(strDrink) ? dictionary.add[language] : dictionary.delete[language]}
          </Button>
        </span>
      </Card>
    </Link>
